...
class ImageMasker:    
    ...
    def mask_full_instance(self, full_img_name, full_img_path):
        ...
        self.INSTANCE_DIR_MODE_RATE = f"{self.INSTANCE_DIR}/{self.mode}_{self.mask_rate}"
        ...
        full_img_masked.save(f"{self.INSTANCE_DIR_MODE_RATE}/{full_img_name}_masked_{self.mode}_{self.mask_rate}{full_img_type}")
