...
class Trainer():
    ...
    def train_model(self):
        ...
        # param_grid = {'C': [0.1, 0.25, 0.33, 0.5, 0.75, 1, 1.25, 1.5, 1.75, 2]}
        # param_grid = {'C': [0.1, 0.25, 0.33, 0.5, 0.75, 1, 1.25, 1.5, 1.75, 2, 2.25, 2.5, 2.75, 3, 3.25, 3.5, 3.75, 4, 4.5, 5]}
        param_grid = {'C': [0.0001, 0.001, 0.01, 0.1, 0.5, 1, 2, 5, 10, 25, 50, 100, 250, 500, 1000, 3333, 5000, 10000, 100000, 500000]}
        # param_grid = {'C': np.arange(start=5, stop=201, step=5)}
